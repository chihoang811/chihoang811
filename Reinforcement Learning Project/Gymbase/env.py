...
class ChefEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.state = (0, 0)  # Reset agent position
        self.collected_ingredients = set()  # Clear collected ingredients
        self.current_budget = self.max_budget  # Reset budget

        return self._get_observation(), {}  # Gym's new API returns (observation, info)
